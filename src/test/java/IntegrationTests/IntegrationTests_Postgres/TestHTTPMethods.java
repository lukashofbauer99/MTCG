...
public class TestHTTPMethods {
    ...
    static void setUp() {
        ...
        workerThread = new Thread(() -> {
            try {
                _listener = new ServerSocket(10005, 5);
            } catch (IOException e) {
                e.printStackTrace();
                return;
            }
    ...
    void testCreateMessages() throws IOException {
        ...
        command = "curl -X POST -H \"Content-type: plain/text\" -d test localhost:10005/messages";
    ...
    void testGetMessages() throws IOException {
        ...
        command = "curl -X GET -H \"Content-type: plain/text\" localhost:10005/messages";
    ...
    void testGetMessageById() throws IOException {
        ...
        command = "curl -X GET -H \"Content-type: plain/text\" localhost:10005/messages/" + testMessage.getId();
    ...
    void testChangeMessageById() throws IOException, InterruptedException {
        ...
        command = "curl -X PUT -H \"Content-type: plain/text\" -d testChanged localhost:10005/messages/" + testMessage.getId();
        command2 = "curl -X GET -H \"Content-type: plain/text\" localhost:10005/messages/" + testMessage.getId();
    ...
    void testDeleteMessageById() throws IOException, InterruptedException {
        ...
        command = "curl -X DELETE -H \"Content-type: plain/text\" localhost:10005/messages/" + testMessage.getId();
        command2 = "curl -X GET -H \"Content-type: plain/text\" localhost:10005/messages/" + testMessage.getId();
